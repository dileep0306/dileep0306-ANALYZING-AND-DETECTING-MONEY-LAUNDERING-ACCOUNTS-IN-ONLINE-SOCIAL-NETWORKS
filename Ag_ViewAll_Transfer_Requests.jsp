...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html">Analyzing and Detecting Money-Laundering Accounts in Online Social Networks<span></span></a></h1>
      </div>
      <div class="menu_nav">
        <ul>
          ...
          <table width="1131" align="center"  cellpadding="0" cellspacing="0"  ">
            ...
            <%
					  String s1,s2,s3,s4,s5,s6,s7,s8;
						...
						String aname=(String)application.getAttribute("aname");
						   	...
						   	String query="select * from agent_transfer where aname='"+aname+"'"; 
            ...
            <tr>
              ...
              <td valign="middle" height="84" style="color:#000000;"align="center"><div align="center">
                  <div align="center" class="style20 style37 style46"><a href="Ag_MoneyTransferStatus.jsp?uname=<%=s1%>&bank=<%=s2%>&facno=<%=s3%>&&tocno=<%=s4%>&amount=<%=s5%>" class="style96 style30 style87"><strong> Transfer To Bank </strong></a></div>
              </div></td>
              <%
